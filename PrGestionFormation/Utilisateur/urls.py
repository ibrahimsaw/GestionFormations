...
urlpatterns = [
    ...
    # -----------------Detail-------------------
    path('detail/<str:role>/<int:pk>/', UtilisateurDetailView.as_view(), name='utilisateur_detail'),
    # -----------------Modifier-------------------
    # path('<str:role>/<int:pk>/modifier/', UtilisateurUpdateView.as_view(), name='utilisateur_update'),
    path('modifier/<str:role>/<int:pk>/modifier/', UtilisateurUpdateView.as_view(), name='utilisateur_modifier'),
    # -----------------Supprimer-------------------
    path('supprimer/<str:role>/<int:pk>/supprimer/', UtilisateurDeleteView.as_view(), name='utilisateur_supprimer'),
