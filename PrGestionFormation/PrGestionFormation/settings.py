"""
Django settings for PrGestionFormation project.
...
SECRET_KEY = 'django-insecure-4m=z&cp#@h$v9zsht-^f-74ceh=f86idt)aje4$9f6k*o!49)='
...
WSGI_APPLICATION = 'PrGestionFormation.wsgi.application'
