...
urlpatterns = [
    ...
    path('users/<int:user_id>/', GererPermissionsUtilisateurView.as_view(), name='gerer_permissions_utilisateur'),
    ...
    path('utilisateur/<int:utilisateur_pk>/historique-actions/', historique_actions_par_utilisateur, name='historique_actions_utilisateur'),
    path('utilisateur/<str:type>/<int:pk>/historique/', HistoriqueUtilisateurView.as_view(), name='historique_utilisateur'),
]